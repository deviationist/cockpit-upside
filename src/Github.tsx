 ...
 *
 * The GitHub "mark" (Octocat) as an inline SVG, shared by the masthead and the
 * setup wizard so the repo link looks the same everywhere. className lets each
 * caller size/colour it for its context.
 */

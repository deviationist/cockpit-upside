...
export const Application = () => {
    ...
    if (path[0] === "ups" && path[1] && path[2] === "metrics") {
        ...
        view = <Metrics ups={path[1]} title={title} archiveDir={config.historyArchiveDir} historyUrl={config.historyUrl} locale={config.locale} autoRefresh={getPref("charts-live") !== "0"} liveScroll={getPref("charts-scroll") !== "0"} lookaheadMs={Number(getPref("charts-lookahead")) || 60_000} />;
